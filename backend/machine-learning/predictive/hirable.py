...
# Downscalling Method For BSc & MSc grades (convert from percentage)
def downscale(score):
    return score/10/2
...
# Separating into dependent and independent variables (create X and Y)
X = dataset.drop(['status'], axis=1)
y = dataset.status

# Splitting dataset into trainig and testing
# Scikit-learn library 
# Randoms select 80% of the data for Training and the other 20% for Testing our model
...
# Saving model to preserve for future use such as deploying to a production server
import pickle
